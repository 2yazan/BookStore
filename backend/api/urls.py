...
urlpatterns = [
    ...
    path('customer/address/add/', views.CustomerAddAddressView.as_view(), name='customer_add_address'),
    path('customer/address/<int:address_id>', views.CustomerDeleteAddressView.as_view(), name='customer_delete_address'),
