      ...
      <div className="lg:max-w-7xl max-w-xl mx-auto">
        <div className="grid lg:grid-cols-4 gap-1 ">
          ...
          <div className="lg:col-span-3 mt-5">
            <div className="p-6">
              <div className="text-lg  flex justify-between font-montserrat text-gray-800 mb-6">
                Account Information
              </div>
              <div className="flex justify-between items-center mb-4">
                ...
                <div className="flex">
                  ...
                  {editableMode ? (
                    <button
                      className="w-28 ml-4 text-white hover:text-gray-800 bg-gradient-to-b from-green-500 to-emerald-500 hover:ring-2 hover:ring-gray-800 rounded-full px-5 py-3 text-center"
                      onClick={handleSave}
                    >
                      Save
                    </button>
