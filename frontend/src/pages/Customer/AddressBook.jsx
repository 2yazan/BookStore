        ...
        <div className="grid lg:grid-cols-4 gap-1">
          ...
          <div className="lg:col-span-3 mt-5">
            <div className="p-6 flex justify-between">
              <div className="text-lg font-montserrat text-gray-800 mb-6">
                Address Book
              </div>
              <button
                className="mb-6 flex text-white hover:text-gray-800 bg-gradient-to-b from-green-500 to-emerald-500 hover:bg-gray-800 hover:ring-2 hover:ring-gray-800  rounded-full px-5 py-3 text-center"
                onClick={() => {
            ...
            <div className="container mt-9 ml-6 mb-80">
              {customer.customer_addresses.map((address, index) => (
                <div key={index} className="mb-6">
                  ...
                  <button
                    className="w-48 ml-4 text-white hover:text-gray-800 bg-gradient-to-b from-green-500 to-emerald-500 hover:ring-2 hover:ring-gray-800 rounded-full px-5 py-3 text-center mb-5"
